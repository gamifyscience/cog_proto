...
public class ControllPerson : MonoBehaviour {
    ...
    {
		if (mirando == true && playercamera.fieldOfView > 37)
        {
			playercamera.fieldOfView = playercamera.fieldOfView - 65.0f * Time.deltaTime;
        }
		if (mirando == false && playercamera.fieldOfView < 60)
        {
			playercamera.fieldOfView = playercamera.fieldOfView + 65.0f * Time.deltaTime;
        }
    }
    ...
    {
//        RaycastHit hitInfo;
		//        Ray cameraRay = playercamera.ViewportPointToRay(centroDaTela);
    }
